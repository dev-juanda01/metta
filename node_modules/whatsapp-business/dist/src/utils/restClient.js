...
var createRestClient = function (_a) {
    var baseURL = _a.baseURL, apiToken = _a.apiToken, errorHandler = _a.errorHandler;
    ...
    fetch.interceptors.response.use(function (response) { return response; }, function (error) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, errorHandler && errorHandler(error)];
    }); }); });
    return {
        fetch: fetch,
